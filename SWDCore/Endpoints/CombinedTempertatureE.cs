...
public class CombinedTempertatureE : DataEndpoint
{
	...
	public override HttpResponse ReturnData(HttpRequest request)
	{
		...
		ServerDataResponse<CombinedTempertatureResponse> response1 = new()
		{
			Type = responseType,
			Message = message,
	...
	{
		Dictionary<string, Task<TemperatureMonitorData[]>> allData = new();
		...
		Dictionary<string, TemperatureResponse> allDataResult = new();
